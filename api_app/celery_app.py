...
this `celery_app`. Tasks live under `api_app.tasks.*`.
...
celery_app.conf.update(
    ...
    task_routes={
        "api_app.tasks.azure.*": {"queue": "azure"},
        "api_app.tasks.blast.*": {"queue": "blast"},
        "api_app.tasks.storage.*": {"queue": "storage"},
    },
