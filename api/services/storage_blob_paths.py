"""Compatibility wrapper for `api.services.storage.blob_paths`.

Responsibility: Re-export the storage blob path validation helper module at the
legacy flat service path.
Edit boundaries: Real implementation lives in `api.services.storage.blob_paths`;
...
from api.services.storage import blob_paths as _impl
