"""Compatibility wrapper for `api.services.storage.local_rbac`.

Responsibility: Re-export the local-debug storage RBAC helper module at the
legacy flat service path.
Edit boundaries: Real implementation lives in `api.services.storage.local_rbac`;
...
from api.services.storage import local_rbac as _impl
