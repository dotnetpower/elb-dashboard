...
The precision report answers whether a sharded run is mechanically mergeable.
This module adds the product-level question: may the run be described as Web
BLAST-compatible, or does it need calibration / explicit approximate labeling?
"""
