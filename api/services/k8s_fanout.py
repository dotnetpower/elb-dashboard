"""Compatibility wrapper for `api.services.k8s.fanout`.

Responsibility: Re-export the Kubernetes fan-out executor helper module at the
legacy flat service path.
Edit boundaries: Real implementation lives in `api.services.k8s.fanout`; do not
add logic here.
...
from api.services.k8s import fanout as _impl
