"""Compatibility wrapper for `api.services.k8s.manifests`.

Responsibility: Re-export the Kubernetes manifest helper module at the legacy
flat service path.
Edit boundaries: Real implementation lives in `api.services.k8s.manifests`; do
not add logic here.
...
from api.services.k8s import manifests as _impl
