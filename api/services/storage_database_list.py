"""Compatibility wrapper for `api.services.storage.database_list`.

Responsibility: Re-export the storage database listing helper module at the
legacy flat service path.
Edit boundaries: Real implementation lives in `api.services.storage.database_list`;
...
from api.services.storage import database_list as _impl
