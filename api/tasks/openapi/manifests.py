...
def build_manifests(
    *,
    ...
    openapi_env = [
        ...
        # Historical warmup Job success is not proof that node-local data
        # survived scale-out, node replacement, or disk loss. Keep the hint
        # disabled even during a rolling update with an older OpenAPI image.
