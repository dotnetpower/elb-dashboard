...
- `ELB_EXISTING_RG_ACTION=number ./scripts/dev/resolve-resource-group.sh --subscription 00000000-0000-0000-0000-0000000000a1 --environment elb-dashboard` -> detected populated `rg-elb-dashboard`, selected `rg-elb-dashboard-01`, and persisted `ELB_RESOURCE_NAME_SLOT=slot01` without deleting anything.
