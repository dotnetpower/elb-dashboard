...
* Live end-to-end (SB outfmt-7 jobs land on the date path + download) recorded after the customer deploy; analytics aggregate (`total_hits > 0`) to be re-verified on a fresh job after the analytics-fix deploy.
