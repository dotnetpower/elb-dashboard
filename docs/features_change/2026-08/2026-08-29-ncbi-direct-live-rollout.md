...
- **Cost cleanup:** after confirming zero active Kubernetes Jobs, the existing `elb-cluster-01` AKS cluster was returned to its pre-validation `Stopped` / `Succeeded` state. No Azure resource was created for the test.
